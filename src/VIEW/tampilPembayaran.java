 ...
 * @author HP
 */
public class tampilPembayaran extends javax.swing.JFrame {

    String[] namaKolom = {"id_bayar", "spp_id", "nim", "tanggal_bayar", "bulan_bayar", "tahun_bayar", "status"};
    ...
    private void Refresh_JTable() {
        ...
        rs = p.Tampil_Pembayaran();
        model.SetTabel(jTable1, rs, namaKolom, jmlKolom, lebar);
    }

    /**
     * Creates new form tampilPembayaran
     */
    ...
    private void initComponents() {
        ...
        jButton3.setText("Edit Pembayaran");
        ...
        jButton5.setText("Hapus Pembayaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tampilPembayaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tampilPembayaran().setVisible(true);
            }
        });
    }
